    ...
    return BlocBuilder<WorkBloc, WorkState>(
      builder: (context, state) {
        return GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, BrokerDeliveryDetails.routeName,
                arguments: work);
          },
          child: Card(
            ...
            child: ListTile(
              ...
              title: Text(
                work.customer!.user!.fullName as String,
                style: TextStyle(
                    color: Theme.of(context).primaryColor,
              ...
              trailing: PopupMenuButton(
                  ...
                  onSelected: (value) async {
                    if (value == 1) {
                      // make it done
                      //  update delivery
                      workBloc.add(MarkAsAccepted(work: work));
                    } else {
